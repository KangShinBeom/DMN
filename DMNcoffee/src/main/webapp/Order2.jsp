   ...
   <div class="question">
      <table style="width: 100%;">
         ...
         <tr>
            ...
            <td>
               <div>
                  <button type="button" class="btn btn-primary btn-sm" id="down<%=i%>">-</button>
                  ...
                  <button type="button" class="btn btn-primary btn-sm" id="up<%=i%>">+</button>
               </div>
            </td>
         </tr>
         <%} } %>
