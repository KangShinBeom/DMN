...
<div class="accordion">
	...
	<div style="width: 100%; height: 60px; position: absolute;">
	    ...
	    <!-- <input class="btn btn-primary" type="button" value="얼음적게">
		<input class="btn btn-primary" type="button" value="얼음많게"> -->
	...
	<div style="height: 60px;">
		...
		<!-- <div class="form-check">
		  ...
		  <label class="btn btn-primary" for="btn-check">샷 추가(+500원)</label>
	      <input type="checkbox" class="btn-check" id="btn-check" autocomplete="off">
		  <label class="btn btn-primary" for="btn-check">휘핑크림(+500원)</label>
	      <input type="checkbox" class="btn-check" id="btn-check" autocomplete="off">
		  <label class="btn btn-primary" for="btn-check">바닐라시럽(+500원)</label>
	      <input type="checkbox" class="btn-check" id="btn-check" autocomplete="off">
		  <label class="btn btn-primary" for="btn-check">헤이즐넛시럽(+500원)</label>
      </div> -->
      
      
      
<!--       	<input class="btn btn-primary" type="checkbox"value="샷 추가
(+500원)">
		<input class="btn btn-primary" type="checkbox" value="휘핑크림
(+500원)">
		<input class="btn btn-primary" type="checkbox" value="바닐라시럽
(+500원)">
		<input class="btn btn-primary" type="checkbox" value="헤이즐넛시럽
(+500원)"> -->
