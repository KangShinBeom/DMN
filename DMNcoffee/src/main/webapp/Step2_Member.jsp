...
$(document).ready(function() {
	...
	$("#next").on("click",function(){
		...
		if($("#discountprice").val() == 0){
			location.href="DiscountServlet?phone2="+phone2+"&phone3="+phone3;
		}else{
	...
	function stampEvent() {
		openWin = window.open("StampEvent.jsp","StampEvent","width=450,height=700,resizable=no,scrollbars=no,top=200,left=740");
