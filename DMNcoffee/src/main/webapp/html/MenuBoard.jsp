...
$(document).ready(function(){
	...
	$(".menu_image").on("click",function(){
		...
		window.name="Menu";
		openWin = window.open("Option.jsp","option","width=450,height=700,resizable=no,scrollbars=no,top=200,left=740");
...
<%
	CategoryDTO cdto = (CategoryDTO)request.getAttribute("CategoryInfo");
...
<div id="carouselExampleDark" class="carousel carousel-dark slide" data-bs-ride="carousel">
  ...
  <div class="carousel-inner" data-bs-interval="1000000">
...
%>
	<td><img class="menu_image" src="image/menu/<%=ctnm%>/<%=pdnm%>.png" data-xxx="<%=pdno%>"></td>
<%
	}//for image
%>
	</tr>
